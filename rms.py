...
lblInfo=Label(Tops,font=('arial',50,'bold'),text="WELCOME TO LOVELY SWEETS ",fg="Steel Blue",bd=10,anchor='w')
...
lblPulav= Label(f1, font=('arial', 16, 'bold'),text="Veg Meal",bd=16,anchor="w") 
